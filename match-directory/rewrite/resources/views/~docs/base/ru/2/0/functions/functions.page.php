...
<p class="hl-info-block">
    Функции для обращения к параметрам баз данных незаменимы при добавлении сторонних библиотек, требующих настройки подключения к той или иной базе данных.
</p>

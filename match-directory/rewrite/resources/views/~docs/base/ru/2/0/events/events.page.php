...
<p>
    Событие <span class="notranslate">KernelEvent</span> не обязательно присутствует в папке с другими Событиями, но если создать файл с таким классом, то оно будет использовано фреймворком. Особенностью его является перехват всех Веб-запросов на самом верхнем уровне и создание глобального действия для них. Как пример, это может быть логирование пользовательских запросов (отсутствует во фреймворке изначально):
</p>
